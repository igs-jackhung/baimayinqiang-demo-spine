// ============================================================
// Require shim: maps @pixi/* bare imports to window.PIXI
// This allows spine-pixi-v7 (CJS bundle) to work in browser
// when PixiJS UMD is loaded globally as window.PIXI
// ============================================================
if (typeof require === 'undefined') {
  window.__pixiRequire = function(mod) {
    var pixi = window.PIXI;
    if (!pixi) throw new Error('[spine-shim] window.PIXI is not defined. Load pixi.min.js first!');
    return pixi; // spine-pixi-v7 uses @pixi/core, @pixi/mesh, @pixi/display, @pixi/ticker - all exported from PIXI
  };
  window.require = window.__pixiRequire;
}
"use strict";
var spine; window.spine = spine = (() => {
...
window.spine = spine; // Force global binding
